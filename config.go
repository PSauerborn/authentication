...
func ConfigureService() {
	...
	ListenPort = OverrideIntegerVariable("LISTEN_PORT", 10081)

	TokenExpiryMinutes = OverrideIntegerVariable("TOKEN_EXPIRY_MINUTES", 120)
	JWTSecret = OverrideStringVariable("JWT_SECRET", "testing-jwt")
}
